...
/**
 * 依 0807 午餐座位圖建立。英文＋數字為桌號，米字號數字為每桌可安排人數。
 * R05、R06、R07 依實際安排改為 4 人桌，所以總席次是 191 而非圖上的 194。
 */
  ...
  groups: [
    {
      ...
      tables: [
        ...
        table("R07", 4, "rect", 42.3, 3.4, 3, 1),
        table("R06", 4, "rect", 47.3, 3.4, 4, 1),
        table("R05", 4, "rect", 52.1, 3.4, 5, 1),
